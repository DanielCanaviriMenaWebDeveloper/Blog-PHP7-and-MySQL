            ...
            <div class="posts-wrapper">
                ...
                <div class="post">
                    <div class="inner-post">
                        <img src="assets/images/image_1.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                        <div class="post-info">
                ...
                <div class="post">
                    <div class="inner-post">
                        <img src="assets/images/image_2.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                        <div class="post-info">
                            <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                            <div>
                                <i class="fa fa-user-o"></i> Awa Melvine
                ...
                <div class="post">
                    <div class="inner-post">
                        <img src="assets/images/image_3.png" alt="" style="height: 200px; width: 100%; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                        <div class="post-info">
                            <h4><a href="single.php">One day your life will flash before your eyes</a></h3>
                            <div>
                                <i class="fa fa-user-o"></i> Awa Melvine
            ...
            <div class="page-content">
                ...
                <div class="post clearfix">
                    ...
                    <div class="post-content">
                        ...
                        <p class="post-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus expedita tempora qui sunt! Ipsum nihil unde obcaecati.</p>
    ...
    <div class="footer">
        <div class="footer-content">
            <div class="footer-section about">
                ...
                <p>AwaInspires is a fictional blog conceived for the purpose of a tutorial on YouTube. However, Awa has a blog called pieceofadvice.org where he writes truly inspiring stuff.</p>
                <!-- <br> -->
                <div class="contact">
